...
// It only supports functions with signature `void()`.
// It is much more efficient than std::function, and only slightly slower than
// a raw std::coroutine_handle<> when used for coroutines.
